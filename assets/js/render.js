    ...
    for(let i = 0;i<x;i++){
        ...
        <div class="product-item">
            ...
            <div class="product-item__info product-item__info-action">
                ...
                <div class="product-item__price">
                    <span class="product-item__price-current" style="font-size: 24px;">${listProduct[i].price}₫</span>
                    <span class="product-item__price-old" style="font-size: 14px;">${listProduct[i].oldPrice}₫</span>
                </div>
            </div>
